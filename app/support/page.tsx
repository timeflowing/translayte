    ...
    const [faqs, setFaqs] = useState<FAQ[]>([
        {
            ...
            answer: "You can create a new project by clicking the '+ Create New Project' button on the Projects page.",
            isOpen: false,
        },
        {
            question: 'How do I update my payment method?',
            answer: "Navigate to the Billing page and click the 'Update Payment Method' button.",
            isOpen: false,
        },
        {
